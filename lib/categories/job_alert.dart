...
class job_alerts extends StatefulWidget {
  static const routename='/job_alerts';

  @override
  State<job_alerts> createState() => _job_alertsState();
}

class _job_alertsState extends State<job_alerts> {
